...
→ Two Fivetran jobs pointed at each other. One moving data in, one moving data out. Both running on a delay — 15 minutes if you're lucky, hours by default.
...
None of those are bi-directional sync. That part surprised me too.
