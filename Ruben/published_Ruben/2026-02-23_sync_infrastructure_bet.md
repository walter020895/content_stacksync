---
name: sync_infrastructure_bet_ruben
description: Real-time sync isn't a feature — it's infrastructure. Most vendors solve the wrong problem. Ruben's founding conviction.
domain: business
...
# RUBEN — Sync Is Infrastructure, Not a Feature
## Angle: Most integration vendors made integration faster to build. Ruben wanted to make it disappear. That was the founding bet.
...
| Lego | Choice |
|------|--------|
| User's Insight | Treating data sync as a project vs. infrastructure produces fundamentally different outcomes. Most vendors optimize for build speed, not operational invisibility. |
| Topic | Why the integration category has the wrong goal |
| Angle | Founder conviction — the market solved the wrong problem, and that's why Stacksync exists |
| Hook Type | Contrarian — reframes the category assumption |
| Story Structure | Contrarian Statement → Commentary (project vs. infrastructure) → Market reality → Founder conviction → Close |
| Psych Triggers | Curiosity Gap, Tribal Identity (engineers who've lived this), Vindication |
...
Infrastructure doesn't work that way. Infrastructure is permanent. It runs in the background. Nobody thinks about it when it's working. You only think about it when it's not.
